...
var template = React.createElement(
    ...
    React.createElement(
        ...
        React.createElement(
            "li",
            null,
            " Swaroopa yogyatha of Vayu is very high compared to other Jivas. He is known as \u201CRiju\u201D "
        ),
        React.createElement(
            "li",
            null,
            " No one equals Vayu in qualities like Bhakthi, Gnana, Vairaagya  (Among jivas)"
        ),
        React.createElement(
            "li",
            null,
            " There is no kali prevesha for vayu deva. (This is same for all Parashukla thrayaru**)"
        ),
        React.createElement(
            "li",
            null,
            "  He does not do any activities against the will of Sri Hari"
        ),
        React.createElement(
            "li",
            null,
            " He is the first among Ekaanta Bhaktas. (Bhaktas donot ask anything from Lord for their seva is called Ekaanta Bhaktas. They don\u2019t even ask Moksha from God.) "
        ),
        React.createElement(
            "li",
            null,
            " When all the Tathvaabhimani devatas in our body leaves a person is able to survive. But when Vayu devaru leaves the human body then the person cannot survive. The mere existence of all Jivas is dependent on Vayu devaru."
        ),
        React.createElement(
            "li",
            null,
            " Even though he is having Linga deha (bondage) it does not have any effect on Vayu devaru."
        )
    )
);
